        ...
        <main>
            <div class="container">
                <div class="d-flex justify-content-start">
                    <a class="btn my-4 text-white p-2" style="background-color: #084298" href="<?php echo e(route('employeecondition.create')); ?>">Add Rules</a>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(Str::limit($rule->rules, 50)); ?></td>
                                                    <td>
                                                     
                                                        <a href="<?php echo e(route('employeecondition.edit', $rule->id)); ?>" class="btn btn-warning btn-sm" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('employeecondition.destroy', $rule->id)); ?>" method="POST" style="display:inline;">
                                                            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/terms/teacher-terms.blade.php ENDPATH**/ ?>