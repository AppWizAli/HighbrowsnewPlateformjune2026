            ...
            <div class="container mt-5">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <form method="POST" action="<?php echo e(route('cordinator.update', $subadmin->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                            ...
                            <a href="<?php echo e(route('cordinator.index')); ?>" class="btn btn-secondary">Cancel</a>
                        </form>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/cordinator/edit.blade.php ENDPATH**/ ?>