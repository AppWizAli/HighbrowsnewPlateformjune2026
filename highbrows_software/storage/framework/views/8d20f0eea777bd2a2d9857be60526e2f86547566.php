            ...
            <div class="container mt-5">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <form action="<?php echo e(route('college.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="subject_name" class="form-label">College Name</label><span style="color: red"> *</span>
                                        <input type="text" class="form-control <?php echo e($errors->has('college_name') ? 'is-invalid' : ''); ?>" id="college_name" name="college_name" value="<?php echo e(old('college_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" class="form-control <?php echo e($errors->has('college_fee') ? 'is-invalid' : ''); ?>" id="college_fee" name="college_fee" value="<?php echo e(old('college_fee')); ?>" step="0.01" min="0">
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/add-college.blade.php ENDPATH**/ ?>