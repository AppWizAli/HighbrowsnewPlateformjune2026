        ...
        <main>
            <div class="container">
                <div class="d-flex justify-content-start">
                    <a class="btn my-4 text-white p-2" style="background-color: #084298" href="<?php echo e(route('subadmin.create')); ?>">Register Teacher</a>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped text-center" id="datatablesSimple">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo e($subadmin->id); ?></td>
                                                <td><?php echo e($subadmin->name); ?></td>
                                                <td><?php echo e($subadmin->contact); ?></td>
                                                <td><?php echo e($subadmin->email); ?></td>
                                                <td>
                                                    <?php if(optional($subadmin->teachers->first())->id): ?> 
                                               
                                                    <a href="<?php echo e(route('teachers.show', $subadmin->teachers->first()->id)); ?>" 
                                                       class="btn btn-info btn-sm" title="View">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('teachers.create', ['id' => $subadmin->id])); ?>" 
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    <a href="<?php echo e(route('subadmin.edit', $subadmin->id)); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                    <form action="<?php echo e(route('subadmin.destroy', $subadmin->id)); ?>" method="POST" style="display:inline;">
                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/subadmin/subadmin.blade.php ENDPATH**/ ?>