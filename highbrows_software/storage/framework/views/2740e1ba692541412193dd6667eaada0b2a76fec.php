...
<form action="<?php echo e(route('blogs.index')); ?>" method="POST" enctype="multipart/form-data">
               <?php echo csrf_field(); ?> 
    <!-- Heading -->
    <div class="mb-3">
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/add-blogs.blade.php ENDPATH**/ ?>