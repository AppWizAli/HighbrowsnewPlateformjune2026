        ...
        <main>
            <div class="container">
                <div class="d-flex justify-content-start">
                    ...
                    <a class="btn my-4 text-white p-2 " style="background-color: #084298" href="<?php echo e(route('college.create')); ?>">Add New College</a>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $colleges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $college): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($college->college_name); ?></td>
                                        <td><?php echo e($college->college_fee); ?></td>
                                                    <td>
                                                        <!-- Edit Button -->
                                                        <a href="<?php echo e(route('college.edit', $college->id)); ?>" class="btn btn-warning btn-sm" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                        
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(route('college.destroy', $college->id)); ?>" method="POST" style="display:inline;">
                                                            <?php echo csrf_field(); ?>
...
<script>
  ...
  </script><?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/colleges.blade.php ENDPATH**/ ?>