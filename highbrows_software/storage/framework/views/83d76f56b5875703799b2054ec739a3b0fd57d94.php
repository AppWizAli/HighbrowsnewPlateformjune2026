                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control <?php echo e($errors->has('subj_name') ? 'is-invalid' : ''); ?>" id="subject_name" name="subj_name" value="<?php echo e(old('subj_name')); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control <?php echo e($errors->has('type') ? 'is-invalid' : ''); ?>" id="type" name="type">
                                            ...
                                            <option value="Mandatory" <?php echo e(old('type') == 'Mandatory' ? 'selected' : ''); ?>>Mandatory</option>
                                            <option value="Optional" <?php echo e(old('type') == 'Optional' ? 'selected' : ''); ?>>Optional</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control <?php echo e($errors->has('pass_marks') ? 'is-invalid' : ''); ?>" id="pass_marks" name="pass_marks" value="<?php echo e(old('pass_marks')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control <?php echo e($errors->has('total_marks') ? 'is-invalid' : ''); ?>" id="final_marks" name="total_marks" value="<?php echo e(old('total_marks')); ?>">
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/add-subject.blade.php ENDPATH**/ ?>