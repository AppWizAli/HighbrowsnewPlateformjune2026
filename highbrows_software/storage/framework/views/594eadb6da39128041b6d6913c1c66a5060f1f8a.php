...
<form id="registrationForm" method="POST" action="<?php echo e(route('cordinator.store')); ?>">
    <?php echo csrf_field(); ?>
   <div class="mb-3">
    <label for="username" class="form-label">Username:</label>
    <input type="text" id="username" name="name" class="form-control" value="<?php echo e(old('name')); ?>" required>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/cordinator/add.blade.php ENDPATH**/ ?>