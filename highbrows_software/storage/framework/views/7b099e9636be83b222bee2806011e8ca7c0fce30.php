    ...
    <div class="vs-menu-area text-center">
        ...
        <div class="mobile-logo">
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/images/mylogo.png')); ?>" alt="Educino">
            </a>
        </div>
            ...
            <ul>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="<?php echo e(url('/academic-program')); ?>">Academic Program</a></li>
                        <li><a href="<?php echo e(url('/program-details')); ?>">Program Details</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children">
                    <a href="<?php echo e(url('/admission-form')); ?>">Admission</a>
                    <ul class="sub-menu">
                        <li><a href="<?php echo e(url('/admission')); ?>">Overview</a></li>
                        <li><a href="<?php echo e(url('/apply-now')); ?>">Apply Now</a></li>
                        <li><a href="<?php echo e(url('/admission-process')); ?>">Admission Process</a></li>
                        <li><a href="<?php echo e(url('/fees-structure')); ?>">Fees Structure</a></li>
                    </ul>
                </li>
...
<header class="vs-header header-layout2" style="background-color: #2c6b43; padding: 10px 0; height: 90px; position: fixed; width: 100%;">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="vs-logo d-none d-lg-block">
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/images/mylogo.png')); ?>" alt="logo" style="width: 60px; height: auto;">
            </a>
        </div>
        ...
        <div style="display: flex; justify-content: center; align-items: center; margin-left: 50px;">
            ...
            <a href="<?php echo e(url('/login')); ?>" class="vs-btn custom-btn">
                <i class="fal fa-user"></i> Login & Register
            </a>
        </div>
    </div>
</header>
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/custom-auth/partials/Navbar.blade.php ENDPATH**/ ?>