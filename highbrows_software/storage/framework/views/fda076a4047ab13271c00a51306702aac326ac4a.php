            ...
            <div class="container mt-5">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <form class="mt-4" action="<?php echo e(route('class.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="examName" name="name" placeholder="Enter class name" required maxlength="255" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <?php echo e(in_array($subject->id, old('subject_id', [])) ? 'checked' : ''); ?>>
...
>
    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option 
            ...
            <?php echo e(in_array($teacher->id, old('teacher_id', [])) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="examNote" rows="3" name="note" placeholder="Enter any notes" maxlength="500"><?php echo e(old('note')); ?></textarea>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/add-class.blade.php ENDPATH**/ ?>