...
<div class="row mt-5">
    <div class="col-md-4 mt-4 text-center">
      <div class="card border-0 shadow">
        <div class="card-body">
          <img src="<?php echo e(Storage::disk('public')->url( $student->passport_pic)); ?>" class="card-img-top rounded-circle mx-auto mt-4" alt="Student Image" style="width: 150px; border: 5px solid #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
          <h5 class="card-title text-uppercase" style="font-size: 15px; font-weight: bold; margin-top: 10px;"><?php echo e($student->full_name); ?></h5>
          <ul class="list-group text-left">
            <li class="list-group-item py-2 border-bottom" style="font-size: 12px;">Class: <?php echo e($student->grade->name); ?></li>

            <li class="list-group-item py-2 border-bottom" style="font-size: 12px;">Registration No. : <?php echo e($student->custom_id); ?></li>
            <li class="list-group-item py-2 border-bottom" style="font-size: 12px;">Date of Birth: <?php echo e(\Carbon\Carbon::parse($student->dob)->format('d M Y')); ?></li>
    ...
    <div class="col-md-12 mt-5">
      ...
      <form method="GET" action="<?php echo e(route('show_student_attendace', $student->id)); ?>" class="mb-3">
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <button type="submit" class="btn text-white" style="background-color: #084298">Filter</button>
          </div>
        </div>
      </form>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/studentAttendance.blade.php ENDPATH**/ ?>