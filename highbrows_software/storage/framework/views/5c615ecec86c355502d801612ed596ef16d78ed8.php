        ...
        <main>
            <div class="container">
                <div class="d-flex justify-content-start">
                    <a class="btn my-4 text-white p-2" style="background-color: #084298" href="<?php echo e(route('blogs.create')); ?>">Add Blog</a>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($blog->image): ?>
                                                        <img src="<?php echo e(asset('storage/app/public/' . $blog->image)); ?>" alt="Blog Image" width="100" height="100">
                                                        <?php else: ?>
                                                            N/A
                                                        <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo e(route('blogs.edit', $blog->id)); ?>" class="btn btn-warning btn-sm" title="Edit">
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/blogs.blade.php ENDPATH**/ ?>