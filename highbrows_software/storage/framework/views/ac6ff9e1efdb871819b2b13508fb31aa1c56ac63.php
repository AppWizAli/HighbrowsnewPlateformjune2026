            ...
            <div class="nav">
                ...
                <div class="collapse" id="subadminMenu" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('cordinator.create')); ?>">Add Subadmin</a>
                        <a class="nav-link" href="<?php echo e(route('cordinator.index')); ?>">Subadmins</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="employeesMenu" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('subadmin.index')); ?>">Register Teacher</a>
                        <a class="nav-link" href="<?php echo e(route('teachers.index')); ?>">Teachers</a>
                        <a class="nav-link" href="<?php echo e(route('salary.index')); ?>">Manage Salary</a>
                        <a class="nav-link" href="<?php echo e(route('employee_attendence')); ?>">Employee Attendance</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="studentsMenu" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('students.index')); ?>">Registered Students</a>
                        <a class="nav-link" href="<?php echo e(route('admissions.index')); ?>">Admission Records</a>
                        <a class="nav-link" href="<?php echo e(route('fees.index')); ?>">Fees of CadetColleges</a>
                        <a class="nav-link" href="<?php echo e(route('students_attendence')); ?>">Student Attendance</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="academicMenu" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('college.index')); ?>">College</a>
                        <a class="nav-link" href="<?php echo e(route('class.index')); ?>">Class</a>
                        <a class="nav-link" href="<?php echo e(route('subject.index')); ?>">Subject</a>
                    </nav>
                </div>
  <!-- Rules -->
...
<div class="collapse" id="rulesMenu" data-bs-parent="#sidenavAccordion">
    <nav class="sb-sidenav-menu-nested nav">
        <a class="nav-link" href="<?php echo e(route('studentcondition.index')); ?>">Student Rules</a>
        <a class="nav-link" href="<?php echo e(route('employeecondition.index')); ?>">Teacher Rules</a>
                ...
                <div class="collapse" id="examsMenu" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('exams.index')); ?>">Exam</a>
                        <a class="nav-link" href="<?php echo e(route('schedule.list')); ?>">Exam Schedule</a>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/sidebar.blade.php ENDPATH**/ ?>