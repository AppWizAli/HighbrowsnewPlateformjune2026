                ...
                <form action="<?php echo e(route('expenses.store')); ?>" method="POST">
                    ...
                    <table class="table table-bordered" id="expensesTable">
                        ...
                        <tbody id="expensesBody">
                            <tr>
                                <td>1</td>
                                <td><input type="text" name="expenses[0][description]" class="form-control" required></td>
                                <td><input type="number" name="expenses[0][amount]" class="form-control expense-amount" required></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><input type="text" name="total" id="expensesTotal" class="form-control" readonly></td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
...
<?php /**PATH /home/u379508397/domains/highbrowsian.com/public_html/highbrows_software/resources/views/admin/expenses/create.blade.php ENDPATH**/ ?>