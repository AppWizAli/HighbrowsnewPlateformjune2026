...
<head>
    ...
    <link rel="stylesheet" href="{{asset('highbro.css')}}">
    <link rel="stylesheet" href="{{asset('menulink.css')}}">
    <link rel="icon" href="{{asset('highbroimage/Logo final.png')}}">
...
<div class="container-fluid" >
    ...
    <script src="{{asset('highbrows.js')}}"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
