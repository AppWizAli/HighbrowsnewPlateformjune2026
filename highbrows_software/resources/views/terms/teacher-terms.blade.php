        ...
        <main>
            <div class="container">
                <div class="d-flex justify-content-start">
                    <a class="btn my-4 text-white p-2" style="background-color: #084298" href="{{ route('employeecondition.create') }}">Add Rules</a>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12">
                                            ...
                                            @foreach ($rules as $index => $rule)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('employeecondition.edit', $rule->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('employeecondition.destroy', $rule->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
