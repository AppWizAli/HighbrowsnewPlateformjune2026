            ...
            <div class="container mt-5">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body bg-light">
                        <form action="{{ route('studentcondition.update', $rule->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{ route('studentcondition.index') }}" class="btn btn-secondary">Cancel</a>
                        </form>
                      </div>
