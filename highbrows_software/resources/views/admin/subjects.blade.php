        ...
        <main>
            <div class="container">
                <div class="d-flex justify-content-start">
                    ...
                    <a class="btn my-4 text-white p-2 " style="background-color: #084298" href="{{route('subject.create')}}">Add New Subject</a>
                </div>
                <div class="row mt-5">
                    <div class="col-md-12">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($subjects as $subject)
                                                <tr>
                                                    ...
                                                    <td>{{ $subject->type }}</td>
                                                    <td>
                                                        <a href="{{ route('subject.edit', $subject->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form id="delete-form-{{ $subject->id }}" action="{{ route('subject.destroy', $subject->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
