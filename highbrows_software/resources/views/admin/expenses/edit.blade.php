                ...
                <form action="{{ route('expenses.update', $expense->id) }}" method="POST">
                    ...
                    <table class="table table-bordered" id="expensesTable">
                        ...
                        <tbody id="expensesBody">
                            @foreach($expense->details as $index => $desc)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>
                                    <input type="text" name="expenses[{{ $index }}][description]" class="form-control" value="{{ $desc['description'] }}" required>
                                </td>
                                <td>
                                    <input type="number" name="expenses[{{ $index }}][amount]" class="form-control expense-amount" value="{{ $desc['amount'] }}" required>
                                </td>
                                <td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><input type="text" name="total" id="expensesTotal" class="form-control" value="{{ $expense->total }}" readonly></td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        let rowCount = {{ count($expense->details ?? []) }};
