...
<div class="row mt-5">
    <div class="col-md-4 mt-4 text-center">
      <div class="card border-0 shadow">
        <div class="card-body">
          <img src="{{Storage::disk('public')->url( $student->passport_pic); }}" class="card-img-top rounded-circle mx-auto mt-4" alt="Student Image" style="width: 150px; border: 5px solid #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
          <h5 class="card-title text-uppercase" style="font-size: 15px; font-weight: bold; margin-top: 10px;">{{ $student->full_name }}</h5>
          <ul class="list-group text-left">
            <li class="list-group-item py-2 border-bottom" style="font-size: 12px;">Class: {{ $student->grade->name }}</li>

            <li class="list-group-item py-2 border-bottom" style="font-size: 12px;">Registration No. : {{ $student->custom_id }}</li>
