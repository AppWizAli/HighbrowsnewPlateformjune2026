                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('subj_name') ? 'is-invalid' : '' }}" id="subject_name" name="subj_name" value="{{ old('subj_name', $subject->subj_name) }}">
                                        @error('subj_name')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('pass_marks') ? 'is-invalid' : '' }}" id="pass_marks" name="pass_marks" value="{{ old('pass_marks', $subject->pass_marks) }}">
                                        @error('pass_marks')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('total_marks') ? 'is-invalid' : '' }}" id="total_marks" name="total_marks" value="{{ old('total_marks', $subject->total_marks) }}">
                                        @error('total_marks')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
