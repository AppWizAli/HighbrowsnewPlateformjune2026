...
$query = "SELECT * FROM explore_highbrows ORDER BY id DESC";
        ...
        <tr>
            ...
            <td>
                <?php if (!empty($row['main_image'])): ?>
                    <img src="/backend/ExploreHighbrows/uploads/<?= htmlspecialchars($row['main_image']) ?>" class="img-thumbnail" style="width: 80px;" alt="Main Image">
                <?php else: ?>
            ...
            <td>
                <?php if (!empty($row['main_image2'])): ?>
                    <img src="/backend/ExploreHighbrows/uploads/<?= htmlspecialchars($row['main_image2']) ?>" class="img-thumbnail" style="width: 80px;" alt="Main Image 2">
                <?php else: ?>
                    <span class="text-muted">No image</span>
                <?php endif; ?>
            </td>
            ...
            <td class="action-btns">
                <a class="edit" href="edit_explore.php?id=<?= $row['id'] ?>"><i class="fas fa-edit"></i> Edit</a>
                <a class="delete" href="delete_explore.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this entry?');"><i class="fas fa-trash"></i> Delete</a>
            </td>
        </tr>
    <?php endwhile; ?>
<?php else: ?>
